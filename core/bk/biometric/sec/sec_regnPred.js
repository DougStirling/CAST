...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnPred_b1')\">1. Estimated response distn at X</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnPred_b3')\">3. Estimating the mean vs prediction</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnPred_b4')\">4. Confidence and prediction intervals</a></dt>\n";
