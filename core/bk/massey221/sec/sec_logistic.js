...
sectionInnerHtml += "<div class='section_note'>\n<p>Least squares is used to predict a numerical response from a numerical explanatory variable. When the response variable is categorical, the goal is to predict the <strong> proportion</strong> in each response category, and a different analysis is required. </p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";
