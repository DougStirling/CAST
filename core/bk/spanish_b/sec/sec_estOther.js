...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estOther4')\">4. Bootstrap error distribution (advanced)</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estOther_b5')\">5. Standard error of correlation from bootstrap</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estOther6')\">6. CIs from simulation (advanced)</a></dt>\n";
