...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estPropn_b5')\">5. Confidence interval for proportion</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estPropn_b7')\">7. Confidence interval examples</a></dt>\n";
if (!hasSummaries || !showingSummary)
