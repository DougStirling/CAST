...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('designTwo_b1')\">1. Experiments with 2 factors</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('designTwo_b2')\">2. Factorial design</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('designTwo_b6')\">6. No-interaction model for three factors</a></dt>\n";
if (!hasSummaries || !showingSummary)
