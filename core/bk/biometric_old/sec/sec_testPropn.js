...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b1')\">1. Inference about parameters</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b2')\">2. P-value for testing proportion</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b3')\">3. Another example</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b4')\">4. One- and two-tailed tests</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b5')\">5. Normal approximation</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPropn_b7')\">7. Tests based on statistical distance</a></dt>\n";
if (!hasSummaries || !showingSummary)
