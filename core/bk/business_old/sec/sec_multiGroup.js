...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_c3')\">3. Revisiting two groups</a>&nbsp;&nbsp;&nbsp;<span class='note'>(optional)</span></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_c6')\">6. Coefficient of determination</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_c8')\">8. Examples</a></dt>\n";
if (!hasSummaries || !showingSummary)
