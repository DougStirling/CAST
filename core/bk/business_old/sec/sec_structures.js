...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_c3')\">3. Categorical variables and groups</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_c5')\">5. Time-ordered data</a></dt>\n";
if (!hasSummaries || !showingSummary)
