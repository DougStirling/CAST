...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c1')\">1. Association</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c2')\">2. Independence</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c3')\">3. Independence from samples</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c4')\">4. Testing for independence</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c7')\">7. Examples</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_c8')\">8. Comparing groups</a></dt>\n";
if (!hasSummaries || !showingSummary)
