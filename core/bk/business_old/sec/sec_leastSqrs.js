...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('leastSqrs_c1')\">1. Predicting Y from X</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('leastSqrs_c3')\">3. Fitted values and residuals</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('leastSqrs_c6')\">6. Residual plots</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('leastSqrs_c7')\">7. Predicting Y and predicting X</a>&nbsp;&nbsp;&nbsp;<span class='note'>(advanced)</span></dt>\n";
if (!hasSummaries || !showingSummary)
