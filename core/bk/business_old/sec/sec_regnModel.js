...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnModel_c1')\">1. Interest in generalising from data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnModel_c2')\">2. Distribution of Y for each X</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnModel_c5')\">5. Model parameters</a></dt>\n";
if (!hasSummaries || !showingSummary)
