...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra_c1')\">1. Margin of error</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra_c2')\">2. Sample size for estimating mean</a></dt>\n";
if (!hasSummaries || !showingSummary)
