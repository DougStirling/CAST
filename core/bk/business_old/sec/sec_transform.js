...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('transform_c2')\">2. Log transformations</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('transform_c3')\">3. When to use log transform?</a></dt>\n";
if (!hasSummaries || !showingSummary)
