...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('scatterplot3')\">2. Limitations of univariate displays</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Univariate displays don't show relationships between variables.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('scatterplot_c4')\">3. Marginal distributions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('scatterplot_c5')\">4. Time series</a></dt>\n";
