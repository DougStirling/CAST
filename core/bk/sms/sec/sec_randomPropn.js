...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp_c3')\">1. Estimating means and proportions</a>&nbsp;&nbsp;&nbsp;<span class='note'>(also in Chapter/Topic 3)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c1')\">2. Proportion and probability</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c2')\">3. Properties of counts and proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c3')\">4. Binomial distribution</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c4')\">5. Binomial probability examples</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c6')\">7. Normal approximation examples</a></dt>\n";
