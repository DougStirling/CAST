...
sectionInnerHtml += "<p class='sectionHeading'>All-or-nothing anova (Optional)</p>\n\n";

sectionInnerHtml += "<div class='section_note'>\n<p>This section shows how the ANOVA table extends to the more complex situations discussed in the previous sections.  It is taken from a different book in CAST and therefore does not have the associated videos. </p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";
