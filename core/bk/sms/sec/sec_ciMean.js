...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciMean_c1')\">1. Confidence interval from standard error</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The estimation error for any estimator, has approximately 0.95 probability of being between -2SE and +2SE. An approximate 95% confidence interval for the parameter is therefore the estimate ± 2SE.</dd>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciMean_c7')\">5. Examples</a></dt>\n";
