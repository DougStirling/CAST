...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures6')\">6. Multi-level data</a>&nbsp;&nbsp;&nbsp;<span class='note'>(advanced)</span></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Sometimes information is available at both group and individual level &mdash; multi-level data. These data are most naturally stored in two data matrices.</dd>\n";
