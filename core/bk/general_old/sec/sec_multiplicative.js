...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiplicative4')\">4. Analysing the right data</a></dt>\n";
if (!hasSummaries || !showingSummary)
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiplicative5')\">5. Types of time series data</a></dt>\n";
if (!hasSummaries || !showingSummary)
