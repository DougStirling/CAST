...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probSim_c4')\">4. Assessing unusual features in data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probSim_c6')\">6. Generating categorical values (advanced)</a>&nbsp;&nbsp;&nbsp;<span class='note'>(advanced)</span></dt>\n";
