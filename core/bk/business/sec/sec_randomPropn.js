...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c1')\">1. Proportion and probability</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c2')\">2. Properties of counts and proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c3')\">3. Binomial distribution</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c4')\">4. Binomial probability examples</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomPropn_c6')\">6. Normal approximation examples</a></dt>\n";
