...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c3')\">3. Choice of classes</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c4')\">4. Histograms of small data sets</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c6')\">6. Comparing groups</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c7')\">7. Histograms with varying class widths</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c9')\">9. Frequency polygons</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c10')\">10. Kernel density estimates</a>&nbsp;&nbsp;&nbsp;<span class='note'>(optional)</span></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Kernel density estimates show density in a still smoother display.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density_c11')\">11. Drawing histograms by hand</a>&nbsp;&nbsp;&nbsp;<span class='note'>(optional)</span></dt>\n";
