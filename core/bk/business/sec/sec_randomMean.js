...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomMean_c6')\">6. Distribution of mean from a sample</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomMean8')\">8. Sampling from finite populations</a>&nbsp;&nbsp;&nbsp;<span class='note'>(advanced)</span></dt>\n";
