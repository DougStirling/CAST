...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnTest_c1')\">1. Importance of zero slope</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnTest_c2')\">2. Testing whether slope is zero</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnTest4')\">4. Properties of p-values</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>As with other tests, all p-values between 0 and 1 are equally likely if the null hypothesis holds (model slope is zero), but p-values nearï¿½0 are more likely if the alternative hypothesis holds (model slope is non-zero).</dd>\n";
