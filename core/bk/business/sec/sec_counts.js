...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts_c1')\">1. Discrete and continuous data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts_c2')\">2. Histograms for counts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts_c3')\">3. Bar charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts_c4')\">4. Mean and st devn</a>&nbsp;&nbsp;&nbsp;<span class='note'>(advanced)</span></dt>\n";
