...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('aboutCast1')\">1. What is CAST?</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>CAST consists of a collection of electronic textbooks (e-books). The main features of CAST are briefly described.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('aboutCast2')\">2. Structure and navigation</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>CAST is structured into chapters, sections and pages in a similar way to a conventional textbook.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('aboutCast3')\">3. Copyright and licence</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The public CAST e-books are provided subject to a Creative Commons licence that allows free copying and use. Customised e-books can be created, but copyright in CAST is retained by the author.</dd>\n";
