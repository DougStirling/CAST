...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('relationship5')\">5. Explanatory and response variables</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>One variable can often be classified as an explanatory variable that either causally affects the response variable, or is useful for predicting its value.</dd>\n";
