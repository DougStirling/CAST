...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_estOther_c2')\">2. Simulation from normal approximation</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_estOther4')\">4. Standard error of correlation from bootstrap</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_estOther_c5')\">5. Confidence interval from error distribution</a></dt>\n";
