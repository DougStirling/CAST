...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_valueDisplay_c1')\">1. The basic dot plot</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_valueDisplay_c2')\">2. Jittered and stacked dot plots</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_valueDisplay_c4')\">4. Basic stem and leaf plot</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_valueDisplay_c5')\">5. Splitting the stems</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_valueDisplay_c8')\">8. Drawing a stem and leaf plot</a></dt>\n";
