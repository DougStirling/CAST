...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_probSim_c4')\">4. Assessing unusual features in data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_probSim5')\">5. Random numbers</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_probSim_c6')\">6. Generating categorical values</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_probSim7')\">7. Generating numerical values</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram illustrates the acceptance/rejection method of generating a random value from a continuous distribution's pdf.</dd>\n";
