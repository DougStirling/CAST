...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_multivariate_c1')\">1. Representing a third variable</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_multivariate_c2')\">2. Rotating 3D scatterplots</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_multivariate_c3')\">3. Scatterplot matrix and brushing</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_multivariate_c5')\">5. Slicing</a></dt>\n";
