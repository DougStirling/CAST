...
sectionInnerHtml += "<p class='sectionHeading'>Abstract infinite populations</p>\n\n";

sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_infPopn_c1')\">1. Data as representatives</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_infPopn_c2')\">2. Randomness of data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_infPopn_c4')\">4. Information from a single sample</a></dt>\n";
