...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnModel_c1')\">1. Histogram of Y for each X</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnModel_c2')\">2. Distribution of Y for each X</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnModel_c5')\">5. Model parameters</a></dt>\n";
