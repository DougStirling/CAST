...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_c1')\">1. Sampling from a population</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram illustrates sampling from a population of objects.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_c2')\">2. Variability in a sample</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_c3')\">3. Sampling error</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_c5')\">5. Sampling with and without replacement</a></dt>\n";
