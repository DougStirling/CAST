...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_curvature_c1')\">1. Transformations and correlation</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_curvature_c2')\">2. Transformations and models</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_curvature_c4')\">4. Quadratic models (cont)</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_curvature_c5')\">5. Dangers of extrapolation</a></dt>\n";
