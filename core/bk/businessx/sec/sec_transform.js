...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_transform_c2')\">2. Log transformations</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_transform_c3')\">3. When to use log transform?</a></dt>\n";
