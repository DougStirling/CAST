...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomPropn_c1')\">1. Distributions of counts and proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomPropn_c3')\">3. Binomial probability examples</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomPropn_c5')\">5. Normal approximation examples</a></dt>\n";
