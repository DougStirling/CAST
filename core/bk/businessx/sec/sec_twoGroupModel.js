...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_c1')\">1. Interest in underlying population</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>A few real data sets where numerical samples are obtained from 2 groups.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_c2')\">2. Model for two groups</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_c4')\">4. Parameter estimates</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>3-dimensional diagrams showing the 'best' normal model for several real data sets. </dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_c5')\">5. Difference between means</a></dt>\n";
