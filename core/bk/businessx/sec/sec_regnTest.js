...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnTest_c1')\">1. Importance of zero slope</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Demonstration that zero slope means that X does not affect Y.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnTest_c2')\">2. Importance of zero slope</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_regnTest_c3')\">3. T-test examples</a></dt>\n";
