...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_prob_c1')\">1. Joint probabilities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_prob_c2')\">2. Marginal probabilities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_prob_c3')\">3. Conditional probabilities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_prob_c5')\">5. Calculations with probabilities</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram shows the calculations involved in Bayes theorem.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_prob_c6')\">6. Calculations with probabilities (cont)</a></dt>\n";
