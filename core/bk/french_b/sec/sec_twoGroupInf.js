...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupInf_b2')\">2. Distribution of estimation error</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupInf_b4')\">4. Testing a hypothesis</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>A hypothesis test is developed for testing whether two group means are the same.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupInf_b5')\">5. One-tailed tests for differences</a></dt>\n";
