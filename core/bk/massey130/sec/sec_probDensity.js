...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity_b1')\">1. Finite populations</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity_b2')\">2. Probabilities with infinite populations</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity7')\">7. Properties of probability</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
