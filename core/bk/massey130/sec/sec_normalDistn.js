...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('correlation2')\">5. Z-scores for data sets</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>A z-score describes the number of standard deviations above the mean.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn5')\">6. Z-scores</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn_b6')\">7. Finding normal probabilities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn_b7')\">8. Other probabilities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn8')\">9. Normal tables</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn9')\">10. Finding normal quantiles</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('normalDistn10')\">11. Normal probability plots</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
