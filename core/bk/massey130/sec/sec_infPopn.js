...
sectionInnerHtml += "<p class='sectionHeading'>Sampling from a distribution</p>\n\n";

sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('infPopn_b1')\">1. Data as representatives</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('infPopn_b2')\">2. Randomness of data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('infPopn_b3')\">3. Model to explain randomness</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('infPopn5')\">4. Information from a sample</a></dt>\n";
