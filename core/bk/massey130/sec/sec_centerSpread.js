...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts4')\">9. Mean and st devn for discrete data</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The mean and standard deviation can be evaluated easily from a frequency table.</dd>\n";
