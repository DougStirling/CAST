...
sectionInnerHtml += "<p class='sectionHeading'>Lurking variables</p>\n\n";

sectionInnerHtml += "<div class='section_note'>\n<p>Relationships between variables are difficult to interpret with observational data. It is easy to wrongly conclude that one variable affects another.</p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('lurking_b1')\">1. Misleading marginal correlation</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('lurking_b2')\">2. Misleading marginal difference in means</a></dt>\n";
