...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_b3')\">3. Inference about two groups</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
