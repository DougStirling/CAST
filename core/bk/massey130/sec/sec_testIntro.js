...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testIntro_b5')\">5. Randomisation tests</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testIntro_b7')\">7. Common patterns in tests</a></dt>\n";
