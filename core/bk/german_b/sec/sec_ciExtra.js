...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra_b1')\">1. Begrenzung des Fehlers</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra2')\">2. Stichprobengröße zur Schätzung von Mittelwerten</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra_b3')\">3. Stichprobengröße zur Schätzung von Proportionen</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('ciExtra4')\">4. Andere Vertrauensintervalle</a></dt>\n";
