...
sectionInnerHtml += "<div class='section_note'>\n<p>Ähnlich wie bei numerischen Variablen kann auch bei kategorialen Variablen der Zusammenhang untersucht werden.</p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep_b1')\">1. Zusammenhang zwischen kategorialen Variables</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep2')\">2. Unabhängigkeit zwischen kategorialen Variablen</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep3')\">3. Unabhängigkeit von Stichproben</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep4')\">4. Testen auf Unabhängigkeit</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep5')\">5. Chi-Quadrat Teststatistik</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep6')\">6. P-Wert des Chi-Quadrat-Test</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep7')\">7. Beispiele</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('indep8')\">8. Vergleich von Gruppen</a></dt>\n";
