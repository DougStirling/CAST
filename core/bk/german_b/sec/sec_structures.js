...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_b1')\">1. Variablen und Individuen</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_b2')\">2.  Arten von Variablen</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_b5')\">5. Zeitlich geordnete Daten</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>In manchen Datenmatrizen sind die Zeilen nach der Zeit geordnet.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('structures_b6')\">6. Multi-level Daten</a>&nbsp;&nbsp;&nbsp;<span class='note'>(fortgeschritten)</span></dt>\n";
