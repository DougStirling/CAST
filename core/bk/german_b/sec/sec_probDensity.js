...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity_b1')\">1. Endliche Grundgesamtheiten</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity_b2')\">2. Wahrscheinlichkeiten innerhalb von Grundgesamtheiten</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('probDensity7')\">7. Eigenschaften von Wahrscheinlichkeiten</a>&nbsp;&nbsp;&nbsp;<span class='note'>(optional)</span></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Hier werden einige Regeln erläutert, denen Wahrscheinlichkeiten grundsätzlich folgen.</dd>\n";
