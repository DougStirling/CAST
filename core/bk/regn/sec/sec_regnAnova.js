...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnAnova4')\">4. Coefficient of determination and experiments</a>&nbsp;&nbsp;&nbsp;<span class='note'>(optional)</span></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>For experimental data, the coefficient of determination is affected both by the strength of the relationship and the range of x-values chosen by the experimenter.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('regnAnova5')\">5. Analysis of variance test</a></dt>\n";
