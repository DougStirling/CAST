...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_b1')\">1. Interest in underlying population</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>A few real data sets where numerical samples are obtained from 2 groups.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupModel_b2')\">2. Model for two groups</a></dt>\n";
