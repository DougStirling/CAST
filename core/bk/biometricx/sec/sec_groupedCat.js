...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_groupedCat_b2')\">2. Contingency table examples</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_groupedCat_b4')\">4. Bar charts using proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_groupedCat_b5')\">5. Stacked bar charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_groupedCat6')\">6. Time series of categorical distns</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_groupedCat7')\">7. Binary variables</a></dt>\n";
