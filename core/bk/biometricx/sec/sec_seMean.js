...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean_b1')\">1. Error distribution for mean</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean_b2')\">2. Standard error when population SD is known</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean_b3')\">3. Standard error when population SD is unknown</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean_b5')\">5. Using SEs to compare estimators</a></dt>\n";
