...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_testPValue1')\">1. Null and alternative hypotheses</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_testPValue_b2')\">2. P-value and consistency with null hypothesis</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_testPValue_b4')\">4. P-values for other tests</a></dt>\n";
