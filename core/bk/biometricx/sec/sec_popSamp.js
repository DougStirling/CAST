...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_b1')\">1. Sampling from a population</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_b3')\">3. Sampling error</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_b4')\">4. Sampling error and sample size</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_popSamp_b5')\">5. Sampling with and without replacement</a></dt>\n";
