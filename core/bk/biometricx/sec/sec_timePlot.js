...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_timePlot_b1')\">1. Time series plots</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_timePlot_b3')\">3. Time series: seasonal pattern</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This example shows a time series with a seasonal pattern.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_timePlot_b4')\">4. Time series: autocorrelation</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This example shows a time series in which successive values are autocorrelated.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_timePlot_b5')\">5. Time series: random fluctuations</a></dt>\n";
