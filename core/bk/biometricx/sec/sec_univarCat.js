...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b1')\">1. Bar charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b4')\">4. Stacked bar charts</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram dynamically stacks the bars of a regular bar chart.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b5')\">5. Pie charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b6')\">6. Comparison of bar and pie charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b8')\">8. Pie charts for quantities</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat_b9')\">9. Chartjunk and misleading diagrams</a></dt>\n";
