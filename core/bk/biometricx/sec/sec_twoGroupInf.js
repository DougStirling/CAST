...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupInf_b2')\">2. Distribution of estimation error</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupInf_b3')\">3. CI for difference between means</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupInf_b5')\">5. Testing a hypothesis</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupInf_b7')\">7. One-tailed tests</a></dt>\n";
