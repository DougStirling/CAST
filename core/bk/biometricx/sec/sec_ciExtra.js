...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_ciExtra3')\">3. Sample size for estimating mean</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_ciExtra_b4')\">4. Sample size for estimating proportion</a></dt>\n";
