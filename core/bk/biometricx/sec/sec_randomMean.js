...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomMean_b1')\">1. Parameters and statistics</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomMean_b5')\">5. Distribution of mean from a sample</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>In this diagram, the sd of a sample mean is estimated for a few data sets.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_randomMean_b6')\">6. Requirement of independence</a></dt>\n";
