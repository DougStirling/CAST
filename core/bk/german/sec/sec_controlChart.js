...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('controlChart7')\">7. Control charts for means</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Control charts are often based on regular small samples rather than individual values. If individual values have a skew distribution, the +/- 3s limits may be exceeded in 2% or more of values. Sample means are closer to normal, so a control chart for means rarely exceeds its control limits when the process is under control.</dd>\n";
