...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('displayInterp6')\">6. Dangers of overinterpretation</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>There is a risk of over-interpreting patterns in small data sets.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('e_displayInterp1')\">7. Exercise: Information from distributions</a></dt>\n";
