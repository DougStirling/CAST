...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('e_scatterplot1')\">6. Exercise: Draw a scatterplot</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>It is more important that you can interpret a scatterplot than draw one by hand. However in this exercise, you will complete a scatterplot by dragging the crosses for the last two observations in a data set -- it checks that you understand how the crosses correspond to the values.</dd>\n";
