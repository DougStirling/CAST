...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('seasonal5')\">5. Putting it all together</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Seasonal data can be split into three components -- seasonal, trend and residual.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('seasonal6')\">6. Forecasting with seasonal data</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The seasonal and trend components of a time series can each be forecast into the future. Adding them provides a forecast for future values. </dd>\n";
