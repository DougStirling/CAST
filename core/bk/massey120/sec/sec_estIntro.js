...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('estIntro3')\">3. Applications of estimation</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
