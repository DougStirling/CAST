...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup1')\">1. Model</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup3')\">3. Inference about two groups</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup6')\">6. Coefficient of determination</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
