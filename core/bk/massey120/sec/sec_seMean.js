...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('seMean6')\">6. Usng SEs to compare estimators</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
