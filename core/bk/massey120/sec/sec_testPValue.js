...
sectionInnerHtml += "<div class='section_note'>\n<p>Understanding the properties of p-values allows you to interpret the results of a wide range of hypothesis tests, even if you do not know the details of how the p-values were obtained.</p> <p>P-values are a difficult concept but are widely used in statistics so it is important to understand what a p-value is telling you. This section explains more fully how they work but will not be directly examined.</p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('testPValue5')\">5. P-values for other tests</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
