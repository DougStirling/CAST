...
sectionInnerHtml += "<div class='section_note'>\n<p>Comparison of groups usually involves differences between means. This section develops some general results about sums and differences of random quantities that will be the basis for comparison of two means.</p> <p>The material in this section will not however be directly examined </p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('sumDiff1')\">1. Means and sums of samples</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('sumDiff2')\">2. Sum and difference</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('sumDiff3')\">3. Sum and difference (cont)</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('sumDiff4')\">4. Probabilities for sums and differences</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
