...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp5')\">5. Sampling from finite populations</a>&nbsp;&nbsp;&nbsp;<span class='note'>Optional (not examined)</span></dt>\n";
