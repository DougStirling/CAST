...
sectionInnerHtml += "<p class='sectionHeading'>Histogrammes et la densité</p>\n\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density4')\">4. Histogrammes de données de petites séries</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density6')\">6. En comparant des groupes</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density7')\">7. Histogrammes avec des largeurs variant de classe</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density10')\">10. Estimations de la densité du noyau</a>&nbsp;&nbsp;&nbsp;<span class='note'>(facultatif)</span></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('density11')\">11. Dessin à la main des histogrammes</a>&nbsp;&nbsp;&nbsp;<span class='note'>(facultatif)</span></dt>\n";
