...
sectionInnerHtml += "<p class='sectionHeading'>Médiane, quartiles et tracés en boîte</p>\n\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('boxPlot5')\">5. Clusters</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Boîtes à moustaches ne peuvent pas montrer des grappes, de sorte ne doivent jamais être utilisé pour les données avec des clusters.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('boxPlot6')\">6. Comparaison des groupes</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Boîtes à moustaches sont particulièrement efficaces pour l'affichage des différences entre plusieurs groupes de valeurs.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('boxPlot7')\">7. Dangers de sur-interprétation</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Boîtes à moustaches sont relativement stables, et contiennent moins de «bruit» que les autres écrans. Ils peuvent décrire les différences entre concise, même de petits groupes.</dd>\n";
