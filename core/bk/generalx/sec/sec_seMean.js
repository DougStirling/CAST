...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean3')\">3. Standard error when population SD is unknown</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seMean5')\">5. Using SEs to compare estimators</a></dt>\n";
