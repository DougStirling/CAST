...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat4')\">4. Stacked bar charts</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram dynamically stacks the bars of a regular bar chart.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat5')\">5. Pie charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat6')\">6. Comparison of bar and pie charts</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_univarCat9')\">9. Chartjunk and misleading diagrams</a></dt>\n";
