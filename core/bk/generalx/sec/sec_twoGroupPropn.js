...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupPropn1')\">1. Estimating difference between proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupPropn3')\">3. CI for difference in proportions</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_twoGroupPropn4')\">4. Testing for difference in probabilities</a></dt>\n";
