...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_testPValue2')\">2. P-value and consistency with null hypothesis</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_testPValue4')\">4. P-values for other tests</a></dt>\n";
