...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seasonal5')\">5. Putting it all together</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>This diagram allows the four components -- seasonal, trend, cyclical and residual -- to be removed from a series and displayed separately.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('l_seasonal6')\">6. Forecasting with seasonal data</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>In this diagram, the seasonal, trend and cyclical components can be extended into the future and added to forecast future values. </dd>\n";
