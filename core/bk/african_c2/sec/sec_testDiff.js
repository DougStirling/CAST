...
sectionInnerHtml += "<p class='sectionHeading'>Hypothesis test for difference</p>\n\n";

sectionInnerHtml += "<dl>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupInf_b4')\">1. Testing a hypothesis</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>A hypothesis test is developed for testing whether two group means are the same.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupInf_b5')\">2. One-tailed tests for differences</a></dt>\n";
