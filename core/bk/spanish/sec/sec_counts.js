...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts1')\">1. Datos discretos y continuos</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts2')\">2. Histogramas para las cuentas</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('counts4')\">4. Media y desviación estándar</a>&nbsp;&nbsp;&nbsp;<span class='note'>(avanzado)</span></dt>\n";
