...
sectionInnerHtml += "<div class='section_note'>\n<p><span style='color:red;'>(Cliquez sur un titre pour afficher la page.)</span></p> <p>Lorsque les données sont collectées, toutes les valeurs sont rarement les mêmes. Un rôle important des statistiques est de décrire et d'analyser cette variation.</p>\n</div>\n\n";
sectionInnerHtml += "<dl>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('variation_a4')\">4. Variability in survey data</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('variation_a6')\">6. Information from variation</a></dt>\n";
