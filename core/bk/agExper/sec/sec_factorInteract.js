...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract_b1')\">1. Model without interaction</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract_b2')\">2. Interaction between factors</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract_b3')\">3. Interaction sum of squares</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>Adding an interaction term reduces the residual sum of squares. The reduction is the sum of squares explained by the interaction term.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract_b4')\">4. Test for interaction</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract5')\">5. Reporting results</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract6')\">6. Experiments with a single replicate</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('factorInteract7')\">7. Tranformations and interaction</a></dt>\n";
