...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp_c1')\">1. Census or sample?</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp_c2')\">2. Variability in a sample</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp_c3')\">3. Sampling error</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>When a sample is used to estimate a population characteristic, an error is usually involved. Sampling error is caused by random selection of the sample from the population. As the sample size is increased, the sampling error becomes smaller. </dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('popSamp6')\">4. Selecting a random sample</a></dt>\n";
