...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel_c1')\">1. Interest in underlying population</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel_c2')\">2. Model for two groups</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel3')\">3. Parameters of the normal model</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The normal model has four parameters — the means and standard deviations in the two groups.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel_c4')\">4. Parameter estimates</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel_c5')\">5. Difference between means</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('twoGroupModel6')\">6. Distribution of a difference</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The difference between two independent normal variables is also normally distributed. Its variance is the sum of the variances of the original variables and its standard deviation is the squares root of this.</dd>\n";
