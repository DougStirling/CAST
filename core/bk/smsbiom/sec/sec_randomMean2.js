...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomMean_b6')\">4. Distribution of mean from a sample</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>It is possible to estimate the distribution of a sample mean from a single sample.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('randomMean_b7')\">5. Requirement of independence</a></dt>\n";
