...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup2')\">2. Parameter estimates</a></dt>\n";
  sectionInnerHtml += "  <dd class='full_text'>The sample standard deviations in the separate groups can be combined to give a pooled estimate of the common standard deviation, σ.</dd>\n";

sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup4')\">3. Variation between and within groups</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_b6')\">5. Coefficient of determination</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup7')\">6. Test for differences between groups</a></dt>\n";
...
sectionInnerHtml += "  <dt class='contents'><a href=\"javascript:showNamedPage('multiGroup_b8')\">7. Examples</a></dt>\n";
